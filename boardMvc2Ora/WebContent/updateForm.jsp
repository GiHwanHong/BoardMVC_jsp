...
<form method="post" name="writeform" action="/boardMvc2Ora/updatePro.do?pageNum=${pageNum}"
...
<table width="400" border="1" cellspacing="0" cellpadding="0" align="center">
	...
	<tr>
		...
		<td align="left" width="330">
		<textarea rows="13" cols="40" name="content">${article.content}</textarea></td>	
	</tr>
	<tr>
		<td width="70" bgcolor="${value_c}" align="center">비밀번호</td>
		<td align="left" width="330">
		 <input type="passwd" size ="8" maxlength="12" name="passwd"></td>
	</tr>
	<tr>
